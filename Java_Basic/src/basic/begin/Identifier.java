...
//		int my birth day = 1234;
		int mybirthday = 1234;
		int myBirthDay = 1234; //camel case 표기법
		int my_Birth_Day = 1234; //snake case 표기법
		
		//4.식별자에 쓸 수 있는 특수문자는 밑줄(_),달러기호($)
		//뿐입니다. 하지만 사용을 권장하지는 않습니다.
		//저 특수문자들은 사용하기를 약속된 곳이 지정되어 있습니다.
		String $hello_ = "안녕";
...
//		String class = "클래스";
		...
		//6. 한글이나 한자 같은 식ㅂㄹ자 이름도 지정이 가능합니다만
		//사용을 권장하지는 않습니다.
		int 숫자 = 10;
		String 名 = "춘식이"; 
