...
public class MethodExample3 {
	...
	private static double[] calcArrayTotal;
	...
	static int[] operateTotal1(int n1, int n2) {
		return new int[] {n1+n2,n1-n2,n1*n2,n1/n2};
	}
	
	static double[] calcArrayTotal(int... ns ) {
		int total = 0;
		for(int n:ns) {
			total += n;
		}
		return new double[] {total,(double)total/ns.length};
	}
	...
	static void divide(int n1,int n2) {
		if(n2==0) {
			System.out.println("zero 로 나눌수 없습니다.");
			return;
		}
		int result = n1 / n2;
		System.out.printf("%d / %d = %d \n",n1,n2,result);
	...
	public static void main(String[] args) {
		...
		int[] totalResult = operateTotal1(30,add(2,4));
        ...
        {57, 89, 78, 91, 93, 47}
        */
		double[] totalResult1  = calcArrayTotal(57, 89, 78, 91, 93, 47);
