...
public class MethodExample2 {
	...
	//x부터 y 까지의 누적합계를 구하는 메서드
	static int calcRangerTotal(int start , int end) {
		int total = 0;
	...
	//매개 변수가 필요 없는 경우
	static String  stselectRandomFood(){
	...
	int result = calcRangerTotal(3,7);
	System.out.println(result);
	
	System.out.println("오늘 점심 뭐 먹지? " + stselectRandomFood());
