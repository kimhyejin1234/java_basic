        ...
        */
		...
		/*
		 ...
		 - Hash 알고리즘을 사용하는 다른 객체가 본래의 속성을 띄게 하려면
		   객체의 필드깂이 같았을 때 같은 hashCode 의 값을 띄게 해 줘야 한다.
		   (HashSet -> HashCode 를 통해 중복 여부를 확인하기 때문)
		 */
		
		Set<Person> personSet = new HashSet<>();
		
		Person kim = new Person("김촌식",30);
		Person kim2 = new Person("김개똥",20);
		
		personSet.add(kim);
		personSet.add(kim2);
		System.out.println(personSet);
		
		Person kim3 = new Person("김개똥",20);
		Person kim4 = new Person("김개ska",20);
		personSet.add(kim3);
		personSet.add(kim4);
		System.out.println(personSet);
