...
public class Main {
    public static void main(String[] args) {
        ...
        List<Apple> greenApples = FilterApple.fillerGreenApples(appleBasket);
        for (Apple greenApple : greenApples) {
            System.out.println(greenApple);
        }

        System.out.println("======= 다양한 사과 필터링 ========");
        List<Apple> filteredColorApples = FilterApple.fillerApplesByColor(appleBasket, RED);
        ...
        System.out.println("===== 빨강 또는 노랑 사과만 필터링 하자 ================");
        filterApple(appleBasket, new ApplePredicate() {
            @Override
        ...
        List<Integer> map3 = MappingApple.map(appleBasket, Apple::getWeight);
