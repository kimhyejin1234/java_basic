...
/*
 *#상수를 정의해서 코드를 장석하면 다양한 문제가 발생할 수 있다.
...
public enum Languages {
	...
	final private String name;//상수와 연관시킬 문자값을 담을 변수 선언
	
	public final String getName() {//한글 이름을 언더내기 위한 메서드(name -> private)
		return name;
	}
