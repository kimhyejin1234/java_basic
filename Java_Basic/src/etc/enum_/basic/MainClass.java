...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("kim 의 주력 언어 : " + kim.lang.getName());
		System.out.println("hong 의 주력 언어 : " + hong.lang.getName());
		System.out.println("park 의 주력 언어 : " + park.lang.getName());
...
//		System.out.println(Languages.valueOf("CVV"));(X)없는 값은 예외 발생
